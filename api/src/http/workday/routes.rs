...
use crate::http::{
    ...
    workday::handlers::{
        ...
        __path_get_workday_creation_limit, __path_get_workday_document_by_month,
        ...
        get_all_workdays_month, get_all_workdays_period, get_workday_by_date,
        get_workday_creation_limit, get_workday_document_by_month, get_workday_documents,
...
pub fn workday_routes() -> OpenApiRouter<AppState> {
    OpenApiRouter::new()
        ...
        .routes(routes!(get_workday_creation_limit))
        ...
        .routes(routes!(get_workday_document_by_month))
}
