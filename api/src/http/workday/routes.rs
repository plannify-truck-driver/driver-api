...
use crate::http::{
    ...
    workday::handlers::{
        ...
        __path_get_all_month, __path_get_all_period, __path_get_all_workday_garbage,
        __path_get_workday_documents, __path_get_workday_documents_by_year, __path_update_workday,
        create_workday, delete_workday, delete_workday_garbage, get_all_month, get_all_period,
        get_all_workday_garbage, get_workday_documents, get_workday_documents_by_year,
        update_workday,
    },
};
